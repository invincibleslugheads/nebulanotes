...
const tempLiteralSent = "I am ${adjective} when I ${verb} for ${Australia}.";
...
let name1 = alph[0] + alph[6];

let name2 = alph[0] + alph[5];

let name3 = alph[0] + alph[6];

let name4 = alph[0] + alph[8];
